            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/')}}">Tabel Bagian</a>
                        </li>
                        @can('create', App\Bagian::class)
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/bagians/create')}}">Tambah Bagian</a>
                        </li>
                        @endcan
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/tabel-karyawan')}}">Tabel Karyawan</a>
                        </li>
                        <li class="nav-item">
